...
namespace DissertationFEPrototype.Optimisations
{
    ...
    /// <summary>
    /// This class is responsible for controlling the refinement process.
    /// </summary>
    class RefinementManager
    {
        ...
        public MeshData GetUpdatedMesh { get  { return this.meshData; } }
         
        public RefinementManager(MeshData meshData, List<NodeAnalysisData> analysisData, int iterationCount, short ILPRefineCount, short stressRefineCount, RuleManager ruleMan)
        {
        ...
        private void stressGradientDrivenRemesh(List<IElement> elements, List<NodeAnalysisData> analysisData)
        {
            ...
            foreach (var elem in elements)
            {
                ...
                {
                    double averageStress = nodeAnalysisData.Select(nad => nad.StressUVMidplace).Average();
                    //
